...
if($sql)
{
echo "<script>alert('La información del paciente se agregó correctamente');</script>";
...
<input type="email" id="patemail" name="patemail" class="form-control"  placeholder="Ingrese la identificación de correo electrónico del paciente" required="true" onBlur="userAvailability()">
