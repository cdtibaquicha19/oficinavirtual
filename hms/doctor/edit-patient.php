...
if($sql)
{
echo "<script>alert('La información del paciente se actualizó correctamente');</script>";
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Ingrese el historial médico del paciente (si corresponde)" required="true"><?php  echo $row['PatientMedhis'];?></textarea>
</div>	
<div class="form-group">
<label for="fess">
Fecha de creación
