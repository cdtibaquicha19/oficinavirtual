...
if($query)
{
	echo "<script>alert('Registrado exitosamente. Puede iniciar sesión ahora');</script>";
}
}
?>
				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post">
						<fieldset>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="password" class="form-control" name="password_again" placeholder="Contraseña de nuevo" required>
									<i class="fa fa-lock"></i> </span>
							</div>
							<div class="form-group">
