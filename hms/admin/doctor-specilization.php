...
$_SESSION['msg']="¡¡La especialización de doctor se agregó con éxito !!";
}
...
<html lang="es">
	<head>
		<title>Admin | Especialización médico</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Especialización médico</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Especialización médico</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Especialización médico</h5>
												</div>
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Ingrese a la especialización del médico">
														</div>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Administrar <span class="text-bold">Doctor Especialización</span></h5>
